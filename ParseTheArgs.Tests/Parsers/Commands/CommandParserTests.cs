...
");
        ...
        public void TryGetOptionName_OptionParserDoesExist_ShouldReturnOptionName()
        {
            ...
            commandParser.TryGetOptionName(targetProperty, out var optionName).Should().BeTrue();
        ...
        public void TryGetOptionName_OptionParserDoesNotExist_ShouldReturnOptionName()
        {
            ...
            commandParser.TryGetOptionName(targetProperty, out var optionName).Should().BeFalse();
