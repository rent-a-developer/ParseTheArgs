...
namespace ParseTheArgs.Tests.Setup.Options
{
    ...
    public class DateTimeListOptionSetupTests
    {
        ...
        public void Constructor_CommandParserIsNull_ShouldThrowException()
        {
            ...
            Invoking(() => new DateTimeListOptionSetup<DataTypesCommandOptions>(null, optionParser))
                .Should()
        ...
        public void Constructor_OptionParserIsNull_ShouldThrowException()
        {
            ...
            Invoking(() => new DateTimeListOptionSetup<DataTypesCommandOptions>(commandParser, null))
                .Should()
                .Throw<ArgumentNullException>();
        }
        ...
        public void Help_ShouldAssignHelpToOptionParser()
        {
            ...
            var setup = new DateTimeListOptionSetup<DataTypesCommandOptions>(commandParser, optionParser);
        ...
        public void DefaultValue_ShouldAssignDefaultValueToOptionParser()
        {
            ...
            var defaultValue = new List<DateTime>();
        ...
        public void DefaultValue_ShouldReturnOptionSetup()
        {
            ...
            setup.DefaultValue(new List<DateTime>()).Should().Be(setup);
        }
