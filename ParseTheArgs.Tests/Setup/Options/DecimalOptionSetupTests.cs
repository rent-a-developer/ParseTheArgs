...
namespace ParseTheArgs.Tests.Setup.Options
{
    ...
    public class DecimalOptionSetupTests
    {
        ...
        public void Constructor_CommandParserIsNull_ShouldThrowException()
        {
            ...
            Invoking(() => new DecimalOptionSetup<DataTypesCommandOptions>(null, optionParser))
                .Should()
        ...
        public void Constructor_OptionParserIsNull_ShouldThrowException()
        {
            ...
            Invoking(() => new DecimalOptionSetup<DataTypesCommandOptions>(commandParser, null))
                .Should()
                .Throw<ArgumentNullException>();
        }
        ...
        public void Help_ShouldAssignHelpToOptionParser()
        {
            ...
            var setup = new DecimalOptionSetup<DataTypesCommandOptions>(commandParser, optionParser);
        ...
        public void DefaultValue_ShouldReturnOptionSetup()
        {
            ...
            setup.DefaultValue(123.456M).Should().Be(setup);
        }
