...
namespace ParseTheArgs.Tests.Setup.Options
{
    ...
    public class Int64ListOptionSetupTests
    {
        ...
        public void Help_ShouldAssignHelpToOptionParser()
        {
            ...
            var setup = new Int64ListOptionSetup<DataTypesCommandOptions>(commandParser, optionParser);
        ...
        public void DefaultValue_ShouldAssignDefaultValueToOptionParser()
        {
            ...
            var defaultValue = new List<Int64>();
        ...
        public void DefaultValue_ShouldReturnOptionSetup()
        {
            ...
            setup.DefaultValue(new List<Int64>()).Should().Be(setup);
        }
