...
namespace ParseTheArgs.Parsers.Arguments
{
    ...
    /// </summary>
    public class GuidArgumentParser : SingleValueArgumentParser<Guid>
    {
        /// <summary>
        ...
        public GuidArgumentParser(PropertyInfo targetProperty, ArgumentName argumentName) : base(targetProperty, argumentName)
        {
        }
