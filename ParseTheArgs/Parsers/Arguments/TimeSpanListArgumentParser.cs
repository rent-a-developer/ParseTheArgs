...
{
    /// <summary>
    /// Parses a command line argument that accepts one or more <see cref="TimeSpan" /> values.
    /// </summary>
    public class TimeSpanListArgumentParser : MultiValueArgumentParser<TimeSpan>
    {
        /// <summary>
        ...
        public TimeSpanListArgumentParser(PropertyInfo targetProperty, ArgumentName argumentName) : base(targetProperty, argumentName)
        {
