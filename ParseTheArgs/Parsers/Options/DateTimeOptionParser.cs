...
{
    /// <summary>
    /// Parses a command line option that accepts a single <see cref="DateTime" /> value.
    /// </summary>
    public class DateTimeOptionParser : SingleValueOptionParser<DateTime>
    {
        /// <summary>
        ...
        /// <exception cref="ArgumentException"><paramref name="targetProperty"/> does not have the property type <see cref="DateTime"/> or <see cref="Nullable{DateTime}"/>.</exception>
