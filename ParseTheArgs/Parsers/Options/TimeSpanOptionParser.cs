...
namespace ParseTheArgs.Parsers.Options
{
    ...
    public class TimeSpanOptionParser : SingleValueOptionParser<TimeSpan>
    {
        ...
        /// <exception cref="ArgumentException"><paramref name="targetProperty"/> does not have the property type <see cref="TimeSpan"/> or <see cref="Nullable{TimeSpan}"/>.</exception>
        ...
        public TimeSpanOptionParser(PropertyInfo targetProperty, String optionName) : base(targetProperty, optionName)
        {
            ...
            if (targetProperty.PropertyType != typeof(TimeSpan) && targetProperty.PropertyType != typeof(Nullable<TimeSpan>))
            {
                throw new ArgumentException($"The given target property has an incompatible property type. Expected type is System.TimeSpan or System.Nullable<System.TimeSpan>, actual type was {targetProperty.PropertyType.FullName}.", nameof(targetProperty));
            }
