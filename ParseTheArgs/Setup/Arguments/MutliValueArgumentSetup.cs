...
namespace ParseTheArgs.Setup.Arguments
{
        ...
        where TArgumentSetup : MultiValueArgumentSetup<TCommandArguments, TArgumentParser, TArgumentSetup, TArgumentValue>
    {
        ...
        protected MultiValueArgumentSetup(CommandParser<TCommandArguments> commandParser, LambdaExpression propertyExpression) : base(commandParser, propertyExpression)
        {
        }
        ...
        public TArgumentSetup DefaultValue(List<TArgumentValue> defaultValue)
        {
