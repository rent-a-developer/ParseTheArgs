...
namespace ParseTheArgs.Setup.Arguments
{
    ...
    public class StringArgumentSetup<TCommandArguments> : SingleValueArgumentSetup<TCommandArguments, StringArgumentParser<TCommandArguments>, StringArgumentSetup<TCommandArguments>, String>
    {
        /// <summary>
