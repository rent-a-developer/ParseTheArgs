...
#pragma warning restore S2436 // Types and methods should not have too many generic parameters
        ...
        where TOptionSetup : SingleValueOptionSetup<TCommandOptions, TOptionParser, TOptionSetup, TOptionValue>
    {
        ...
        protected SingleValueOptionSetup(CommandParser<TCommandOptions> commandParser, LambdaExpression propertyExpression) : base(commandParser, propertyExpression)
        {
        }
